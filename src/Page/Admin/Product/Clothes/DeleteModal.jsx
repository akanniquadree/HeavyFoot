...
function DeleteModal({open, handleClose,setOpen, id}) {
    const deleteProduct = async() =>{
        const deleted = await axios.delete(`https://ecommerces-api.herokuapp.com/api/v1/admin/delete_product/${id}`, {headers: {"Authorization": "Bearer 41|kOxux51mqFmCChDku6VI85INKOsPGx000hmCdnpk" }})
        setOpen(false)
        console.log(deleted)
    }
